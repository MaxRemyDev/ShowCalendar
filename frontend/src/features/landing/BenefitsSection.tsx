...
const benefits = [
	{
		icon: <CalendarDays className="h-20 w-20 text-gray-400" />,
	...
	{
		icon: <SquareCheckBig className="h-20 w-20 text-gray-400" />,
	...
	{
		icon: <Settings2 className="h-20 w-20 text-gray-400" />,
	...
	{
		icon: <PieChart className="h-20 w-20 text-gray-400" />,
...
export const BenefitsSection = () => {
	...
	return (
		<Section>
			...
			<p className="text-xl text-center mb-12 text-gray-500">
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
				{benefits.map((benefit) => (
					...
					>
						...
						<div className="w-full px-4 py-2 md:px-6 md:py-3 lg:px-8 lg:py-4">
