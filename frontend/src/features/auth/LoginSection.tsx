		...
		<div className="relative w-full h-screen">
			<div className="relative z-10 flex flex-col items-center justify-center w-full h-full lg:grid lg:grid-cols-2">
				...
				<div className="flex flex-col items-center justify-center max-sm:justify-start w-full h-full p-10 max-sm:pt-5 max-sm:pb-0 space-y-6 max-sm:space-y-0">
					{/* BUTTON SIGN UP TOP LEFT OR BOTTOM LEFT */}
					<div className="hidden lg:flex absolute space-y-2 top-4 left-4 lg:bottom-5 lg:left-4 space-x-5 md:top-8 md:left-8">
						<Button
							asChild
							shadow="xxl"
					...
					{/* BUTTON THEME MODE TOP LEFT */}
					<div className="absolute bottom-5 left-4 ml-5 max-lg:top-4 lg:left-4 lg:ml-0 hidden sm:block">
						<OneClickModeToggle />
					</div>
					...
					{/* BUTTON SIGN UP BOTTOM LEFT FOR LG */}
					<div className="lg:hidden absolute bottom-5 left-4 space-x-5 max-sm:bottom-20 max-sm:mx-5">
						<Button
							asChild
							shadow="xxl"
					...
					{tip.tip && (
						<div className="absolute z-20 bottom-5 right-5">
							<blockquote className="space-y-2">
								<h3 className="text-sm text-end font-bold">TIPS: N°{tip.number}</h3>
								<p className="text-lg text-end">&ldquo;{tip.tip}&rdquo;</p>
							</blockquote>
						</div>
					)}
				</div>
